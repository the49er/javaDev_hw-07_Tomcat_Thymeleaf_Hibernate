...
@Slf4j
public class ProjectDaoJDBC implements CrudEntityDaoJDBC<Project> {

    private static final String TABLE_NAME = "`homework_7`.projects";
    ...
    public ProjectDaoJDBC(Connection connection) {
        try {
