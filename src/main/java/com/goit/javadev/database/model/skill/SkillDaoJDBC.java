...
@Slf4j
public class SkillDaoJDBC implements CrudEntityDaoJDBC<Skill> {

    private static final String TABLE_NAME = "`homework_7`.skills";
    ...
    public SkillDaoJDBC(Connection connection) {
        try {
